      ...
      <Container fluid className="home__background" id="home">
        ...
        <Row>
          ...
          <Col lg={4} className="pt-5" data-aos="flip-right">
            ...
            <p className="pt-5 heading_para">Merocare E-ticketing and Consulation is the online hospital ticketing services for care—offering by the technology to kbuy the tickets, 
      ...
      <Container id="about" data-aos="fade-up">
        <Row>
          ...
          <Col lg={6} md={6} sm={12} className="py-5">
            <p className="heading__3">Merocare was founded on a simple, yet revolutionary idea: that everyone should have access to the best healthcare, anywhere in the world on their terms. Today, we're delivering on our mission by providing whole-person virtual care that includes primary care, mental health, chronic condition management and more.</p>
         <p className="heading__3">
         We're creating a truly unified and personalized consumer experience; developing technologies to connect to 
         patients and extend the reach of care providers; delivering the highest standard of clinical quality at every touchpoint; 
         and enhancing health decisions and outcomes with smart data and actionable insights.
         </p>
          </Col>
